...
function rowLabel(row) {
    if (row.month === "AVG") return safeT("hrDashboard.turnover.avg", "AVG")
    ...
    <div class="turnover-chart-wrap">
        ...
        >
            ...
            <text
                ...
                :y="padding.top - 15"
                text-anchor="middle"
                class="turnover-chart__target"
            >
                {{ safeT("hrDashboard.turnover.targetLessThan", "Target <") }}{{ formatPercent(targetRate) }}
            </text>
            ...
            >
                ...
                <text
                    ...
                    text-anchor="middle"
                    class="turnover-chart__value turnover-chart__value--previous"
                >
                ...
                <text
                    ...
                    text-anchor="middle"
                    class="turnover-chart__value turnover-chart__value--current"
                    :class="{
        ...
        <div class="turnover-chart__legend">
            <span>
...
.turnover-chart__title {
    fill: #555555;
    font-size: 1.35rem;
    font-weight: 700;
}

.turnover-chart__target {
    fill: #ffffff;
    font-size: 0.82rem;
    font-weight: 800;
}

.turnover-chart__value {
    font-size: 0.66rem;
    font-weight: 800;
}

.turnover-chart__value--previous {
    fill: #444444;
}

.turnover-chart__value--current {
    fill: #0047ff;
}

.turnover-chart__value--current.is-over-target {
    fill: #ff0000;
}

.turnover-chart__month {
    fill: #333333;
    font-size: 0.77rem;
    font-weight: 700;
}

.turnover-chart__legend {
    display: flex;
    align-items: center;
...
.turnover-chart__legend span {
    display: inline-flex;
    align-items: center;
    gap: 0.25rem;
}

.turnover-chart__legend i {
