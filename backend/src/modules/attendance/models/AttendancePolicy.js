...
const attendancePolicySchema = new Schema(
    {
        ...
        minimumWorkedMinutes: {
            type: Number,
            min: 0,
            max: 1440,
            default: 0,
        },
        lateRoundUnitMinutes: {
            type: Number,
            min: 1,
            max: 240,
            default: 1,
        ...
        earlyLeaveRoundUnitMinutes: {
            type: Number,
            min: 1,
            max: 240,
            default: 1,
        },
        earlyLeaveRoundMethod: {
            type: String,
            enum: ["FLOOR", "CEIL", "NEAREST"],
            default: "CEIL",
        },
...
attendancePolicySchema.index(
    ...
    {
        unique: true,
        name: "uq_attendance_policy_scope_code",
    },
)
...
attendancePolicySchema.index(
    ...
    {
        name: "idx_attendance_policy_scope_status",
    },
)
